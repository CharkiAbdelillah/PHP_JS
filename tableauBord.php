...
<table width="100%" border="1">
  <tbody>
    ...
    <tr>
      ...
      <td><a  onclick="return confirm('tu veux continuer ?')" href="supprimer.php?supCar=<?php echo $ligne['IMM']; ?>"><img src="images/supprimer.png" width="50px" height="50px"></a></td>
      <td><a onclick="return confirm('tu veux continuer ?')" href="modifier.php?mod=<?php echo $ligne['IMM'];?>"><img src="images/modifier.png" width="50px" height="50px"></a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
